                    ...
                    margin: EdgeInsets.fromLTRB(0, 30, 0, 0),
                     child: Container (
                      ...
                      borderRadius: BorderRadius.only(
                       ...
                       image: DecorationImage(
                image: AssetImage('assets/desain.jpg'), fit: BoxFit.fill),
          ),
          child: Container(
                          margin: EdgeInsets.only(top: 150, bottom: 10, left: 30, right: 0),
                           //color: Colors.green,
                  ...
                  params: Code128BarCodeParams(
                    "$_scanBarcode",
                    lineWidth: 2,                // width for a single black/white bar (default: 2.0)
